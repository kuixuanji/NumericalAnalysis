...
% 临时复制主函数前期的几何提取逻辑：
MDH_params = [0,pi,-0.1564-0.1284; 0,pi/2,-0.0054-0.0064; 0,-pi/2,-0.2104-0.2104; 0,pi/2,-0.0064-0.0064; 0,-pi/2,-0.2084-0.1059; 0,pi/2,0; 0,-pi/2,-0.0615-0.1059; 0,pi,0];
d = MDH_params(:,3);
